...
La naming convention per questi file è:
...
Le iterazioni storiche usate per creare e rifinire le skill del repository sono conservate separatamente in `docs/skill-iterations/`.
